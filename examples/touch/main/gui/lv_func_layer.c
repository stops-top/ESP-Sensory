...
static void lv_func_create_layer(lv_layer_t * create_layer)
{
    bool result = false;
...
void lv_goto_layer(lv_layer_t * src_layer, lv_layer_t * dst_layer)
{
    bool result = false;
    ...
    if(src_layer){
        if(src_layer->lv_obj_layer){
            ...
            if(src_layer->lv_show_layer){
                result = src_layer->lv_show_layer->exit_cb(src_layer->lv_show_layer);
